...
export default function FloatingNavbar({
  ...
  return (
    <div className="w-full absolute top-0 left-0 z-50 pt-4 px-4 sm:px-6 transition-all duration-300">
      ...
      <div
        className={`max-w-5xl mx-auto mt-2 bg-white rounded-3xl shadow-xl overflow-hidden lg:hidden transition-all duration-600 ease-in-out ${isOpen ? "max-h-[400px] translate-y-0 " : "max-h-0 -translate-y-4 overflow-hidden"}`}
      >
