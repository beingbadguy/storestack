  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center bg-gradient-to-b from-gray-50 to-white p-4 py-12">
      <div className="w-full max-w-2xl rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] overflow-hidden bg-white border border-gray-100">
        {/* Header Section */}
        <div className="bg-gradient-to-r from-orange-500 to-orange-400 p-8 flex flex-col items-center justify-center text-white">
        ...
        <div className="p-10 md:px-12">
          ...
          <div className="space-y-3">
            ...
            <a
              href="/"
              className="inline-block mt-4 px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white font-medium rounded-lg transition-colors"
            >
              Go to Homepage
            </a>
          </div>
